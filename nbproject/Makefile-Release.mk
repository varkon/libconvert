...
${OBJECTDIR}/src/clients/converterclient.o: src/clients/converterclient.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/clients/converterclient.o src/clients/converterclient.cpp

${OBJECTDIR}/src/converters/Json2XmlConverter.o: src/converters/Json2XmlConverter.cpp
	${MKDIR} -p ${OBJECTDIR}/src/converters
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/converters/Json2XmlConverter.o src/converters/Json2XmlConverter.cpp

${OBJECTDIR}/src/converters/Xml2JsonConverter.o: src/converters/Xml2JsonConverter.cpp
	${MKDIR} -p ${OBJECTDIR}/src/converters
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/converters/Xml2JsonConverter.o src/converters/Xml2JsonConverter.cpp

${OBJECTDIR}/src/interfaces/BuilderConverter.o: src/interfaces/BuilderConverter.cpp
	${MKDIR} -p ${OBJECTDIR}/src/interfaces
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interfaces/BuilderConverter.o src/interfaces/BuilderConverter.cpp

${OBJECTDIR}/src/services/ConverterServiceImpl.o: src/services/ConverterServiceImpl.cpp
	${MKDIR} -p ${OBJECTDIR}/src/services
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/services/ConverterServiceImpl.o src/services/ConverterServiceImpl.cpp

${OBJECTDIR}/src/services/libconvert.o: src/services/libconvert.cpp
	${MKDIR} -p ${OBJECTDIR}/src/services
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/services/libconvert.o src/services/libconvert.cpp

${OBJECTDIR}/src/services/soapC.o: src/services/soapC.cpp
	${MKDIR} -p ${OBJECTDIR}/src/services
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/services/soapC.o src/services/soapC.cpp

${OBJECTDIR}/src/services/soapconverterserviceProxy.o: src/services/soapconverterserviceProxy.cpp
	${MKDIR} -p ${OBJECTDIR}/src/services
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/services/soapconverterserviceProxy.o src/services/soapconverterserviceProxy.cpp

${OBJECTDIR}/src/services/soapconverterserviceService.o: src/services/soapconverterserviceService.cpp
	${MKDIR} -p ${OBJECTDIR}/src/services
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/services/soapconverterserviceService.o src/services/soapconverterserviceService.cpp
