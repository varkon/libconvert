...
#ifndef soapconverterserviceService_H
#define soapconverterserviceService_H
#include "soapH.h"

    class SOAP_CMAC converterserviceService : public soap {
      public:
        ...
        /// Copy constructor
        converterserviceService(const converterserviceService&);
        /// Construct service given a managing context
        converterserviceService(const struct soap&);
        /// Constructor taking input+output mode flags for the new managing context
        converterserviceService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        converterserviceService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and managing context
        virtual ~converterserviceService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void converterserviceService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual converterserviceService *copy() SOAP_PURE_VIRTUAL;
        /// Copy assignment
        converterserviceService& operator=(const converterserviceService&);
        ...
        virtual int MakeConvert(t__input *request, t__result *result) SOAP_PURE_VIRTUAL;
    };
#endif
